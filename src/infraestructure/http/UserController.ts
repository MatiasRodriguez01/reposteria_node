...
export class UserController {
    ...
    async getAll(req: Request, res: Response<any, User[]>) {
    ...
    async getById(req: Request<ParamId, any, any, any>, res: Response) {
    ...
    async create(req: Request<any, any, CreateUserBody, any>, res: Response) {
    ...
    async update_item(req: Request<any, any, any, QueryUpdateUser>, res: Response) {
